...
function AppContent() {
 ...
 if (!isAuthenticated) {
  if (SHOW_LEGACY_LOGIN) {
   return (
    <div className="relative min-h-screen bg-gradient-to-br from-pinkTP to-pinkTP flex items-center justify-center">
     <LoginPage />
    </div>
   );
  }
  ...
  return (
   <div className="min-h-screen bg-bg02 overflow-y-auto">
     ...
     {view ==="inventory-list" ? (
      ...
      >
       <div className="p-6">
        ...
        <p className="text-text02">Full inventory list coming soon...</p>
       </div>
      </motion.div>
     ) : (
      <motion.div
