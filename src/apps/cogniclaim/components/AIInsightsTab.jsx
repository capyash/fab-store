   ...
   {loading ? (
    ...
    <div className="space-y-4">
     <div className="flex items-center gap-2">
      ...
      <h2 className="font-semibold text-pinkTP">AI Recommendation</h2>
     </div>

     <p className="text-sm text-text01 whitespace-pre-line">
      {output.summary}
     </p>

     <div className="text-sm bg-pinkTP/10 p-3 rounded-md">
     ...
     <div className="flex items-center justify-between text-xs text-text03">
      ...
      <button
       ...
       className="flex items-center gap-1 px-2 py-1 bg-pinkTP text-white text-xs rounded-md"
      >
