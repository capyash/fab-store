...
export default function FabStoreEntry() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[buttonPrimary] via-[textLink] to-pinkTP text-white flex items-center justify-center px-6 py-10">
        ...
        <div className="bg-white/10 border border-white/20 rounded-3xl p-6 md:p-10 backdrop-blur">
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <div className="p-4 rounded-2xl bg-white/10">
              <Store className="w-12 h-12 text-alert01" />
            </div>
