...
export default function PitchHub({ onNavigate }) {
 ...
 const metrics = [
  {
   ...
   gradient:"from-neutral010 to-neutral010",
  },
  {
   icon: Zap,
   value:"72% reduction",
   ...
   gradient:"from-pinkTP/100 to-pinkTP/100",
  },
  {
   icon: DollarSign,
   ...
   gradient:"from-success010 to-success010",
  },
  {
   icon: Shield,
   ...
   gradient:"from-alert010 to-alert010",
  },
 ];
 ...
 const architectureComponents = [
  ...
  },
  {
   ...
   color:"from-error010 to-pinkTP/100",
  },
 ];
 ...
 const OverviewTab = (
  <div className="space-y-6">
   {/* Hero Pitch */}
   <div className="bg-gradient-to-br from-pinkTP/10 to-pinkTP/20/20 rounded-xl p-6 border border-pinkTP/20">
    <div className="flex items-start gap-4">
     <div className="p-3 rounded-lg bg-gradient-to-br from-pinkTP to-pinkTP shadow-lg">
      <Sparkles className="w-6 h-6 text-white" />
     </div>
     <div className="flex-1">
      <h2 className="text-2xl font-bold text-text01 mb-3">
       Cogniclaim: SOP-Native Claims Intelligence
      </h2>
      <p className="text-base leading-relaxed text-text01 mb-4">
      ...
      <div className="flex items-center gap-2 text-sm text-pinkTP font-medium">
   ...
   {/* Problem Statement */}
   <div className="bg-white rounded-xl p-6 border border-stroke01">
    <h3 className="text-lg font-semibold text-text01 mb-3 flex items-center gap-2">
     <Shield className="w-5 h-5 text-pinkTP" />
     The Problem
    </h3>
   ...
   <div className="bg-white rounded-xl p-6 border border-stroke01">
    <h3 className="text-lg font-semibold text-text01 mb-3 flex items-center gap-2">
     <Network className="w-5 h-5 text-pinkTP" />
     How It Fits Today
    </h3>
    <ul className="space-y-2 text-sm text-text02">
     <li className="flex items-start gap-2">
      <span className="text-pinkTP font-bold mt-0.5">•</span>
   ...
   {/* CTA */}
   <div className="bg-gradient-to-r from-pinkTP to-pinkTP rounded-xl p-6 text-white">
    ...
    <button className="px-4 py-2 bg-white text-pinkTP rounded-lg font-medium hover:bg-bg03 transition-colors">
     Schedule Demo
    </button>
   </div>
  </div>
 ...
 const MetricsTab = (
  <div className="space-y-6">
   <div className="bg-white rounded-xl p-6 border border-stroke01">
    ...
    <p className="text-sm text-text02 mb-6">
     ...
     {metrics.map((metric, idx) => {
      ...
      return (
       <motion.div
        ...
        className="bg-gradient-to-br from-bg02 to-bg03 rounded-xl p-5 border border-stroke01"
       >
        ...
        <div className="text-2xl font-bold text-text01 mb-2">
         {metric.value}
        </div>
        <div className="text-sm font-semibold text-text01 mb-2">
         {metric.label}
        </div>
        <div className="text-xs text-text02 leading-relaxed">
         {metric.description}
        </div>
       </motion.div>
      );
 ...
 const ArchitectureTab = (
  <div className="space-y-6">
   ...
   {/* Component Details */}
   <div className="bg-white rounded-xl p-6 border border-stroke01">
    <h3 className="text-lg font-semibold text-text01 mb-4">Core Components</h3>
     ...
     {architectureComponents.map((component, idx) => {
      ...
      return (
       <motion.div
        ...
        transition={{ delay: idx * 0.1 }}
        className="flex items-start gap-4 p-4 rounded-xl border border-stroke01 bg-gradient-to-r from-bg02 to-white"
       >
        <div className={`p-3 rounded-lg bg-gradient-to-br ${component.color} shadow-md flex-shrink-0`}>
         <Icon className="w-5 h-5 text-white" />
        </div>
        <div className="flex-1">
         <h4 className="font-semibold text-text01 mb-1">{component.title}</h4>
         <p className="text-sm text-text02">{component.description}</p>
        </div>
       </motion.div>
      );
     })}
 ...
 const HowItWorksTab = (
  <div className="space-y-6">
   <div className="bg-white rounded-xl p-6 border border-stroke01">
    ...
    <div className="space-y-6">
     <div>
      <h4 className="font-semibold text-text01 mb-2 flex items-center gap-2">
       <span className="w-6 h-6 rounded-full bg-pinkTP text-white text-xs flex items-center justify-center">1</span>
       SOP Ingestion & Parsing
      </h4>
      <p className="text-sm text-text02 ml-8">
     ...
     <div>
      <h4 className="font-semibold text-text01 mb-2 flex items-center gap-2">
       <span className="w-6 h-6 rounded-full bg-pinkTP text-white text-xs flex items-center justify-center">2</span>
     ...
     <div>
      <h4 className="font-semibold text-text01 mb-2 flex items-center gap-2">
       <span className="w-6 h-6 rounded-full bg-pinkTP text-white text-xs flex items-center justify-center">3</span>
     ...
     <div>
      <h4 className="font-semibold text-text01 mb-2 flex items-center gap-2">
       <span className="w-6 h-6 rounded-full bg-pinkTP text-white text-xs flex items-center justify-center">4</span>
     ...
     <div>
      <h4 className="font-semibold text-text01 mb-2 flex items-center gap-2">
       <span className="w-6 h-6 rounded-full bg-pinkTP text-white text-xs flex items-center justify-center">5</span>
 ...
 return (
  <div className="h-full flex flex-col overflow-hidden">
   {/* Header */}
   <div className="flex items-center justify-between px-6 py-4 border-b border-stroke01 bg-gradient-to-r from-pinkTP to-pinkTP">
    ...
    {onNavigate && (
     <button
      ...
      className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-pinkTP bg-white rounded-lg hover:shadow-lg transition-all duration-200 hover:scale-105 active:scale-95"
     >
   ...
   {/* Footer */}
   <div className="px-6 py-4 border-t border-stroke01 bg-bg02 flex items-center justify-between">
    <div className="text-xs text-text03">
     Need more details? Contact us for a personalized demo.
    </div>
    <button className="px-4 py-2 bg-pinkTP hover:bg-pinkTP text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-2">
