...
function Card({ children, className ="" }) {
 return (
  <div
   className={
   "rounded-2xl border border-stroke01/70 bg-white/80 backdrop-blur" +
    className
   }
  >
   {children}
  ...
  <div className="space-y-6 pb-6 px-6 pt-6">
   ...
   >
    <div className="flex-1">
     <h1 className="text-xl font-bold text-text01 mb-2">
      Reports & Analytics
     </h1>
    ...
    {onNavigate && (
     <button
      ...
      className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-pinkTP to-pinkTP rounded-lg hover:shadow-lg transition-all duration-200 hover:scale-105 active:scale-95"
     >
    ...
    <motion.div variants={fadeUp} initial="hidden" animate="show" custom={0}>
     <Card className="p-5">
      <div className="flex items-center justify-between mb-4">
       <div>
        <div className="font-semibold text-text01 text-lg">
    ...
    <motion.div variants={fadeUp} initial="hidden" animate="show" custom={1}>
     <Card className="p-5">
      <div className="flex items-center justify-between mb-4">
       ...
       <ArrowUpRight className="w-5 h-5 text-[success03]" />
      </div>
      <div className="h-48">
       <ResponsiveContainer width="100%" height="100%">
    ...
    >
     <Card className="p-5">
      <div className="flex items-center justify-between mb-4">
       ...
       <Activity className="w-5 h-5 text-[success03]" />
      </div>
      <div className="h-56">
       <ResponsiveContainer width="100%" height="100%">
    ...
    <motion.div variants={fadeUp} initial="hidden" animate="show" custom={4}>
     <Card className="p-5">
      <div className="flex items-center justify-between mb-4">
       ...
       <ArrowUpRight className="w-5 h-5 text-pinkTP" />
      </div>
      <div className="h-48">
       <ResponsiveContainer width="100%" height="100%">
