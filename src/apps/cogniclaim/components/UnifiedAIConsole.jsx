  ...
  while ((match = sopRegex.exec(text)) !== null) {
   ...
   parts.push(
    <button
     ...
     className="inline-flex items-center gap-1 px-1.5 py-0.5 mx-0.5 rounded-md bg-pinkTP/10 text-pinkTP/20 hover:bg-pinkTP/30:bg-pinkTP/30 transition-colors text-xs font-medium border border-pinkTP/20"
      ...
      >
       <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
         ...
         <p className="text-sm text-text02">Cogniclaim is analyzing the claim using multi-agent reasoning...</p>
