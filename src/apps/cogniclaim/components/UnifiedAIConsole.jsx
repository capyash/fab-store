    ...
    while ((match = sopRegex.exec(text)) !== null) {
      ...
      parts.push(
        <button
          ...
          className="inline-flex items-center gap-1 px-1.5 py-0.5 mx-0.5 rounded-md bg-[#780096]/10 text-[#780096] dark:text-[#780096] dark:bg-[#780096]/20 hover:bg-[#780096]/20 dark:hover:bg-[#780096]/30 transition-colors text-xs font-medium border border-[#780096]/20 dark:border-[#780096]/30"
