  ...
  return (
    <div className="space-y-6 p-6">
      ...
      >
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-neutral01 text-sm">Parts, tools, and equipment management</p>
              </div>
            </div>
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
            ...
            <div className="text-xs text-neutral01 mt-1">Total Items</div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
            <div className="text-2xl font-bold">{stats.inStock}</div>
            <div className="text-xs text-neutral01 mt-1">In Stock</div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
            <div className="text-2xl font-bold text-alert02">{stats.lowStock}</div>
            <div className="text-xs text-neutral01 mt-1">Low Stock</div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
            <div className="text-2xl font-bold text-error03">{stats.outOfStock}</div>
            <div className="text-xs text-neutral01 mt-1">Out of Stock</div>
          </div>
        </div>
        ...
        <div className="mt-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
          <div className="flex items-center justify-between">
            <span className="text-sm text-neutral01">Total Inventory Value</span>
      ...
      {outOfStockItems.length > 0 && (
        <div className="rounded-xl border border-error01 bg-error01 p-4">
          <div className="flex items-center gap-2 mb-3">
            <AlertTriangle className="w-5 h-5 text-error03" />
            <h2 className="text-lg font-semibold text-error02">Out of Stock Items</h2>
          </div>
      ...
      {lowStockItems.length > 0 && (
        <div>
          <h2 className="text-lg font-semibold text-text01 mb-4 flex items-center gap-2">
            <TrendingDown className="w-5 h-5 text-alert02" />
            Low Stock Items
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-text01">View All Inventory</h3>
              <p className="text-sm text-text02 mt-1">Browse and manage all inventory items</p>
            </div>
