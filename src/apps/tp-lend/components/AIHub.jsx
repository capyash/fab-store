...
import LoanContextBar from"./LoanContextBar";
...
export default function AIHub({ loan, onBack }) {
 ...
 const handleSOPView = (sopId, scenario, loanStatus, stepIndex) => {
  setViewerSopId(sopId);
  setViewerScenario(scenario || loan?.scenario);
 ...
 return (
  <div className="flex flex-col h-full overflow-hidden bg-bg02">
   ...
   <div className="flex flex-1 overflow-hidden">
    ...
    <SOPReferencePanel
     claim={loan} // Reuse Cogniclaim's SOPReferencePanel (it accepts generic item)
