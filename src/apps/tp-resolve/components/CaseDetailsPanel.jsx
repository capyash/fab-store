 ...
 const DetailsTab = (
  <div className="space-y-4 text-sm">
   ...
   {caseData.originalDecision && (
    <div className="mt-4 p-3 bg-bg02 rounded-lg">
     <div className="text-xs text-text03 uppercase tracking-wide mb-2">Original Decision</div>
 ...
 return (
  <div className="bg-white border-l border-stroke01 w-96 flex flex-col h-full">
   <div className="flex items-center justify-between p-4 border-b border-stroke01">
    <h3 className="text-lg font-semibold text-text01">Case Details</h3>
    <button
     onClick={onClose}
