...
export default function PlatformDetail({ platform, onBack, onLaunch, readOnly, onRequestLogin }) {
  ...
  return (
    <div className="px-4 md:px-10 pb-16 space-y-8">
      ...
      <section className="rounded-[32px] bg-gradient-to-br from-[#780096]/10 to-[#780096]/10 border border-[#780096]/20 shadow-[0_35px_85px_rgba(15,10,45,0.12)] p-8 space-y-6 backdrop-blur">
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Platform Metrics</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-xl bg-white/80 border border-[#780096]/20 p-4">
            ...
            <div className="rounded-xl bg-white/80 border border-[#780096]/20 p-4">
              <div className="flex items-center gap-2 mb-2">
                <Globe className="w-5 h-5 text-[#780096]" />
            ...
            <div className="rounded-xl bg-white/80 border border-[#780096]/20 p-4">
              <div className="flex items-center gap-2 mb-2">
                <Users className="w-5 h-5 text-[#780096]" />
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {platform.documentation.features.map((feature, idx) => (
                <li key={idx} className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#780096] mt-0.5 shrink-0" />
        ...
        <section className="rounded-[32px] bg-white/95 border border-white/40 shadow-[0_35px_85px_rgba(15,10,45,0.12)] p-8 space-y-6 backdrop-blur">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="px-4 py-2 rounded-full bg-[#780096]/10 text-[#780096] text-sm font-semibold">
            ...
            {isAgenticSupport ? (
              agenticWorkflows.map((workflow) => {
                ...
                return (
                  ...
                  >
                    <div className="h-1.5 w-full bg-gradient-to-r from-[#780096] to-[#780096]" />
                    <div className="absolute top-2 right-2 px-2 py-1 rounded-full bg-[#780096]/10 text-[#780096] text-[10px] font-semibold z-10">
                      {workflow.status}
                    </div>
                    <div className="p-6 flex flex-col gap-4">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#780096] to-[#780096] flex items-center justify-center">
                      ...
                      <button
                        className="mt-2 w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-[#780096] to-[#780096] text-white font-semibold text-sm hover:shadow-lg transition-all"
                      >
                        Try Workflow
      ...
      {platform.documentation?.architecture && (
        <section className="rounded-[32px] bg-white/95 border border-white/40 shadow-[0_35px_85px_rgba(15,10,45,0.12)] p-8 space-y-6 backdrop-blur">
              ...
              <div className="space-y-4">
                {platform.documentation.architecture.diagram.layers.map((layer, idx) => (
                  <motion.div
                    ...
                    className="p-4 rounded-lg border-2 border-[#780096]/30 bg-white"
                  >
                    <div className="flex items-start gap-3 mb-2">
                      <div className="w-8 h-8 rounded-full bg-[#780096] text-white flex items-center justify-center font-bold text-sm shrink-0">
                        {idx + 1}
                      </div>
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {layer.components.map((comp, compIdx) => (
                            <span key={compIdx} className="px-2 py-1 rounded-md bg-[#780096]/10 text-[#780096] text-xs font-medium">
                              {comp}
                            </span>
                          ))}
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {platform.documentation.architecture.components?.map((component, idx) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: idx * 0.1 }}
                  className="p-5 rounded-xl border border-gray-200 bg-gray-50 hover:border-[#780096]/50 transition-colors"
                >
                  <div className="flex items-start gap-3 mb-3">
                    {idx === 0 && <Database className="w-5 h-5 text-[#780096] mt-0.5 shrink-0" />}
                    {idx === 1 && <Brain className="w-5 h-5 text-[#780096] mt-0.5 shrink-0" />}
                    {idx === 2 && <GitBranch className="w-5 h-5 text-[#780096] mt-0.5 shrink-0" />}
                    {idx === 3 && <Code className="w-5 h-5 text-[#780096] mt-0.5 shrink-0" />}
          ...
          {platform.documentation.architecture.dataFlow && (
            <div className="mt-6 p-6 rounded-xl bg-gradient-to-r from-[#780096]/5 to-[#780096]/5 border border-[#780096]/20">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <Zap className="w-5 h-5 text-[#780096]" />
                {platform.documentation.architecture.dataFlow.title}
              </h3>
              <div className="space-y-3">
                {platform.documentation.architecture.dataFlow.steps.map((step, idx) => (
                  <div key={idx} className="flex items-start gap-4 p-4 rounded-lg bg-white border-l-4 border-[#780096]">
                    <div className="w-8 h-8 rounded-full bg-[#780096] text-white flex items-center justify-center font-bold text-sm shrink-0">
                      {step.step}
                    </div>
                    <div className="flex-1">
      ...
      {platform.documentation?.integration && (
        <section className="rounded-[32px] bg-white/95 border border-white/40 shadow-[0_35px_85px_rgba(15,10,45,0.12)] p-8 space-y-6 backdrop-blur">
          <div className="flex items-center gap-3 mb-4">
            <BookOpen className="w-6 h-6 text-[#780096]" />
          ...
          <div className="space-y-6">
            {platform.documentation.integration.steps?.map((step, idx) => (
              <div key={idx} className="border-l-4 border-[#780096] pl-6 py-2">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 rounded-full bg-[#780096] text-white flex items-center justify-center font-bold">
                    {step.step}
                  </div>
      ...
      {platform.documentation?.bestPractices && (
        <section className="rounded-[32px] bg-white/95 border border-white/40 shadow-[0_35px_85px_rgba(15,10,45,0.12)] p-8 space-y-6 backdrop-blur">
          <div className="flex items-center gap-3 mb-4">
            <FileText className="w-6 h-6 text-[#780096]" />
