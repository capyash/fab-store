      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-text01">AI Platforms Hub</h1>
              <p className="text-lg text-text02 mt-1">Reusable platforms for rapid application development</p>
            </div>
          </div>
        ...
        <section className="mb-12">
          <div className="bg-white rounded-2xl p-8 border border-stroke01 shadow-sm mb-8">
            <h2 className="text-2xl font-bold text-text01 mb-6">Platform Overview</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 rounded-xl bg-gradient-to-br from-pinkTP/5 to-pinkTP/5">
                <div className="text-4xl font-bold text-pinkTP mb-2">{platforms.length}</div>
                <div className="text-sm font-medium text-text02">Live Platforms</div>
              </div>
              <div className="text-center p-6 rounded-xl bg-gradient-to-br from-pinkTP/5 to-pinkTP/5">
                <div className="text-4xl font-bold text-pinkTP mb-2">{fabApps.filter((a) => a.platformId).length}</div>
                <div className="text-sm font-medium text-text02">Solutions Built</div>
              </div>
              <div className="text-center p-6 rounded-xl bg-gradient-to-br from-pinkTP/5 to-pinkTP/5">
                <div className="text-4xl font-bold text-pinkTP mb-2">2</div>
                <div className="text-sm font-medium text-text02">Industries Covered</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white rounded-2xl p-8 border border-stroke01 shadow-sm">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-text01">{sopPlatform.name}</h2>
                    <p className="text-text02 mt-1">{sopPlatform.tagline}</p>
                  </div>
                </div>
                <span className="px-3 py-1 rounded-full bg-success01 text-success02 text-sm font-semibold">
                  {sopPlatform.status}
                </span>
              </div>

              <p className="text-text01 mb-6 leading-relaxed">{sopPlatform.description}</p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h3 className="font-semibold text-text01 mb-3">Core Capabilities</h3>
                  <ul className="space-y-2">
                    {sopPlatform.highlights.map((highlight, idx) => (
                      <li key={idx} className="flex items-center gap-2 text-text02">
                ...
                <div>
                  <h3 className="font-semibold text-text01 mb-3">Technology Stack</h3>
                  <div className="flex flex-wrap gap-2">
                    {sopPlatform.stack.map((tech, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 rounded-full bg-bg03 text-text01 text-sm font-medium"
                      >
                        {tech}
                      </span>
                    ))}
              ...
              <div className="border-t border-stroke01 pt-6">
                <h3 className="font-semibold text-text01 mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {sopSolutions.map((app) => (
                    <div
                      key={app.id}
                      className="p-4 rounded-lg border border-stroke01 bg-bg02 hover:bg-bg03 transition-colors cursor-pointer"
                      onClick={() => onNavigate && onNavigate("store")}
                    >
                      <div className="font-semibold text-text01 mb-1">{app.name}</div>
                      <div className="text-sm text-text02">{app.industry}</div>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {fieldServicePlatform && (
          <section className="mb-12">
            <div className="bg-white rounded-2xl p-8 border border-stroke01 shadow-sm">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[neutral02] to-[neutral02] flex items-center justify-center shadow-lg">
                    <Zap className="w-8 h-8 text-white" />
                  </div>
                  <div>
                    <h2 className="text-3xl font-bold text-text01">{fieldServicePlatform.name}</h2>
                    <p className="text-text02 mt-1">{fieldServicePlatform.tagline}</p>
                  </div>
                </div>
                <span className="px-3 py-1 rounded-full bg-success01 text-success02 text-sm font-semibold">
              ...
              <p className="text-text01 mb-6 leading-relaxed">{fieldServicePlatform.description}</p>
          ...
          <div className="bg-white rounded-2xl p-8 border border-stroke01 shadow-sm">
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-text01">Agentic Support Orchestration</h2>
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="flex flex-wrap gap-1 justify-end">
                  <span className="px-2 py-0.5 rounded-full bg-bg03 text-text01 text-xs">FastAPI</span>
                  <span className="px-2 py-0.5 rounded-full bg-bg03 text-text01 text-xs">Agentic</span>
                  <span className="px-2 py-0.5 rounded-full bg-bg03 text-text01 text-xs">Workflows: 2</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <h3 className="font-semibold text-text01 mb-3">Supported Workflows</h3>
                <ul className="space-y-2 text-text02 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-success03 mt-0.5" />
                    <div>
              ...
              <div>
                <h3 className="font-semibold text-text01 mb-3">How it works</h3>
                <ul className="space-y-2 text-text02 text-sm">
                  <li className="flex items-start gap-2">
                    <Code className="w-4 h-4 text-pinkTP mt-0.5" />
                    <span>
                  ...
                  <li className="flex items-start gap-2">
                    <BarChart3 className="w-4 h-4 text-pinkTP mt-0.5" />
                    <span>
                  ...
                  <li className="flex items-start gap-2">
                    <Database className="w-4 h-4 text-pinkTP mt-0.5" />
                    <span>
                      Exposes clean APIs (
                      <code className="px-1 py-0.5 bg-bg03 rounded text-[11px]">/trigger-workflow</code>,{" "}
                      <code className="px-1 py-0.5 bg-bg03 rounded text-[11px]">/get-workflow-status</code>,{" "}
                      <code className="px-1 py-0.5 bg-bg03 rounded text-[11px]">/simulate-telemetry</code>) for any UI or CCaaS to call.
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-stroke01 pt-4">
              <div className="text-xs text-text03">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-pinkTP text-white text-sm font-semibold hover:bg-pinkTP"
              >
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-text01 mb-6">How to Build on Platforms</h2>
          <div className="bg-white rounded-2xl p-8 border border-stroke01 shadow-sm">
            <div className="space-y-6">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="font-semibold text-text01 mb-2">Choose Your Platform</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="font-semibold text-text01 mb-2">Define Your Data</h3>
                  <p className="text-text02 text-sm">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="font-semibold text-text01 mb-2">Create Platform Adapter</h3>
                  <p className="text-text02 text-sm">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="font-semibold text-text01 mb-2">Integrate Platform Components</h3>
                  <p className="text-text02 text-sm">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="font-semibold text-text01 mb-2">Customize for Your Industry</h3>
                  <p className="text-text02 text-sm">
        ...
        {/* Platform Benefits */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-text01 mb-6">Platform Benefits</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 border border-stroke01 shadow-sm">
              <Code className="w-8 h-8 text-pinkTP mb-4" />
              <h3 className="font-semibold text-text01 mb-2">Faster Development</h3>
            ...
            <div className="bg-white rounded-xl p-6 border border-stroke01 shadow-sm">
              <Shield className="w-8 h-8 text-pinkTP mb-4" />
              <h3 className="font-semibold text-text01 mb-2">Built-in Compliance</h3>
              <p className="text-sm text-text02">
            ...
            <div className="bg-white rounded-xl p-6 border border-stroke01 shadow-sm">
              <BarChart3 className="w-8 h-8 text-pinkTP mb-4" />
              <h3 className="font-semibold text-text01 mb-2">Enterprise-Grade AI</h3>
              <p className="text-sm text-text02">
