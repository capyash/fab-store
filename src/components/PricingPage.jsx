  ...
  const plans = [
    {
      ...
      bgColor: "bg-neutral01",
      borderColor: "border-neutral01",
    },
    {
      name: "Developer",
      icon: Building2,
      ...
      cta: "Start Building",
      popular: true,
      color: "from-pinkTP to-pinkTP",
      bgColor: "bg-pinkTP/10",
      borderColor: "border-pinkTP/40",
    },
    {
      name: "Enterprise",
      icon: Crown,
    ...
    <div className="min-h-screen bg-[bg02]">
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-6">
        ...
        <div className="mb-8 text-center">
          <button
            onClick={onBack}
            className="flex items-center gap-2 text-pinkTP hover:text-pinkTP transition-colors mb-4 mx-auto"
          >
            <ArrowLeft className="w-4 h-4" />
            <span className="font-medium">Back to Store</span>
          </button>
          <div className="flex items-center justify-center gap-3 mb-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-pinkTP to-pinkTP flex items-center justify-center shadow-lg">
              <Sparkles className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-text01">Pricing</h1>
              <p className="text-base text-text02 mt-0.5">Choose the plan that fits your needs</p>
            </div>
          </div>
          <p className="text-text01 max-w-2xl mx-auto text-sm">
              ...
              <div
                ...
                className={`relative rounded-xl border-2 ${
                  plan.popular
                    ...
                    : "border-stroke01 shadow-sm"
                } bg-white overflow-hidden`}
              >
                {plan.popular && (
                  <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-pinkTP to-pinkTP text-white text-xs font-semibold py-1.5 text-center">
                    Most Popular
                  </div>
                )}
                <div className={`p-6 ${plan.popular ? "pt-10" : ""}`}>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-xl font-bold text-text01">{plan.name}</h3>
                  </div>
                  <div className="mb-3">
                    <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-bold text-text01">{plan.price}</span>
                      {plan.period && (
                        <span className="text-text02 text-xs">/{plan.period}</span>
                      )}
                    </div>
                  </div>
                  <p className="text-xs text-text02 mb-4">{plan.description}</p>
                  <button
                    className={`w-full py-2.5 rounded-lg font-semibold text-sm transition-all mb-4 ${
                      plan.popular
                        ? "bg-gradient-to-r from-pinkTP to-pinkTP text-white hover:shadow-lg"
                  ...
                  <div className="space-y-2">
                    {plan.features.map((feature, featureIdx) => (
                      <div key={featureIdx} className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-pinkTP shrink-0 mt-0.5" />
                        <span className="text-xs text-text01 leading-relaxed">{feature}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-text01 mb-4">Add-ons & Extensions</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {addOns.map((addOn, idx) => (
              <div
                key={idx}
                className="bg-white rounded-lg p-4 border border-stroke01 shadow-sm hover:shadow-md transition-shadow"
              >
                <h3 className="font-semibold text-text01 mb-1.5 text-sm">{addOn.name}</h3>
                <p className="text-xs text-text02 mb-2">{addOn.description}</p>
                <div className="text-base font-bold text-pinkTP">{addOn.price}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* FAQ */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-text01 mb-4">Frequently Asked Questions</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-4 border border-stroke01 shadow-sm">
              <h3 className="font-semibold text-text01 mb-2 text-sm">Can I change plans later?</h3>
            ...
            <div className="bg-white rounded-lg p-4 border border-stroke01 shadow-sm">
              <h3 className="font-semibold text-text01 mb-2 text-sm">What happens if I exceed my AI request limit?</h3>
              <p className="text-xs text-text02">
            ...
            <div className="bg-white rounded-lg p-4 border border-stroke01 shadow-sm">
              <h3 className="font-semibold text-text01 mb-2 text-sm">Do you offer discounts for annual plans?</h3>
              <p className="text-xs text-text02">
                Yes, annual plans receive a 20% discount. Contact our sales team for Enterprise annual pricing.
              </p>
            </div>
            <div className="bg-white rounded-lg p-4 border border-stroke01 shadow-sm">
              <h3 className="font-semibold text-text01 mb-2 text-sm">Is there a free trial for paid plans?</h3>
              <p className="text-xs text-text02">
            ...
            <div className="bg-white rounded-lg p-4 border border-stroke01 shadow-sm">
              <h3 className="font-semibold text-text01 mb-2 text-sm">What payment methods do you accept?</h3>
              <p className="text-xs text-text02">
            ...
            <div className="bg-white rounded-lg p-4 border border-stroke01 shadow-sm">
              <h3 className="font-semibold text-text01 mb-2 text-sm">Can I get a custom quote?</h3>
              <p className="text-xs text-text02">
        ...
        {/* Enterprise CTA */}
        <section className="bg-gradient-to-br from-pinkTP to-pinkTP rounded-xl p-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button className="px-6 py-2.5 bg-white text-pinkTP rounded-lg font-semibold text-sm hover:bg-bg03 transition-colors">
              Contact Sales
            </button>
