   ...
   {/* Content */}
    ...
    <div className="flex items-center justify-between mb-1.5 shrink-0">
     <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2">
       <h3 className="text-sm md:text-base font-bold text-text01 leading-tight">
        {config.title}
       </h3>
       {confidence > 0 && (
        <motion.span
    ...
    <div className="flex-1 min-h-0 mb-1.5 space-y-2.5">
     {index === 0 && (
      <>
       ...
       >
        <p className="text-[13px] md:text-sm text-text01 leading-snug">
         {isStreaming ? (
          <>
           {primaryText}
     ...
     {index === 1 && (
      <>
       <motion.div
        ...
        transition={{ delay: index * 0.1 + 0.1 }}
       >
        <p className="text-[13px] md:text-sm text-text01 leading-snug line-clamp-2">
         {primaryText}
        </p>
       </motion.div>
       ...
       {(matchedSopRefs.length > 0 || primarySOP || scenarioTag || item?.cptCode || item?.icd10Code) && (
        ...
        >
         ...
         <div className="flex flex-wrap gap-1.5">
          ...
          {primarySOP && (
           <span className="px-2.5 py-1 rounded text-[10px] font-semibold bg-pinkTP/10/80 text-textLink border border-pinkTP/40/70">
            {primarySOP.title}
    ...
    <div className="shrink-0 mt-1">
     <div className="h-1.5 bg-stroke01 rounded-full overflow-hidden shadow-inner">
      <motion.div
       initial={{ width: 0 }}
     ...
     <div className="mt-0.5 text-[10px] text-text02 text-right font-semibold">
      {actualProgress}%
     </div>
    </div>
   </div>
